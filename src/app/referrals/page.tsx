...
export default function ReferralsPage() {
  ...
  // Per-level income array: index 0=total, 1-20 = per-level (BUSD units)
      ...
      <GlassCard>
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-1 text-xs text-oslo-text-muted">
            ...
            <span>Commission on downline profit claims</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          {Array.from({ length: 20 }, (_, i) => i + 1).map((level) => {
            ...
            // Per-level income from contract (BUSD units, 18 decimals)
        ...
        <div className="mt-6 p-4 rounded-lg bg-oslo-ice/5 border border-oslo-ice/10">
          <p className="text-xs text-oslo-text-secondary">
            <strong className="text-oslo-ice">How Level Income Works:</strong>
            <br />
            • You earn commission when your downline claims their yield/profits
            <br />
            • Commission is calculated on the <strong>profit portion</strong> (0.50% daily), not the full claim
            <br />
            • Higher levels require more qualified direct referrals to unlock
            <br />
            • Qualified = Direct referral with $100+ BUSD deposit
            <br />
            • Income shown is lifetime earnings at each level
          </p>
        </div>
      </GlassCard>
