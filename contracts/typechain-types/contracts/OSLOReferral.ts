...
export interface OSLOReferralInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "migrateEarnings",
...
export interface OSLOReferral extends BaseContract {
  ...
  migrateEarnings: TypedContractMethod<
    [
      _users: AddressLike[],
      _totalEarned: BigNumberish[],
      _referralRewards: BigNumberish[]
    ],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "migrateEarnings"
  ): TypedContractMethod<
    [
      _users: AddressLike[],
      _totalEarned: BigNumberish[],
