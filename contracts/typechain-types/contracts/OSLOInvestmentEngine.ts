...
export namespace ReferralUpdatedEvent {
  export type InputTuple = [oldReferral: AddressLike, newReferral: AddressLike];
  export type OutputTuple = [oldReferral: string, newReferral: string];
  export interface OutputObject {
    oldReferral: string;
    newReferral: string;
  }
...
export interface OSLOInvestmentEngine extends BaseContract {
  connect(runner?: ContractRunner | null): OSLOInvestmentEngine;
  waitForDeployment(): Promise<this>;

  interface: OSLOInvestmentEngineInterface;
  ...
  filters: {
    ...
    "ReferralUpdated(address,address)": TypedContractEvent<
      ReferralUpdatedEvent.InputTuple,
      ReferralUpdatedEvent.OutputTuple,
      ReferralUpdatedEvent.OutputObject
    >;
