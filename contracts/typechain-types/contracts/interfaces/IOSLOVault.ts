...
export interface IOSLOVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getActiveDeposit"
      | "getUserTier"
...
export interface IOSLOVault extends BaseContract {
  connect(runner?: ContractRunner | null): IOSLOVault;
  waitForDeployment(): Promise<this>;

  interface: IOSLOVaultInterface;
