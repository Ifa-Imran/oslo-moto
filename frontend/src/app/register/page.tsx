...
const REGISTRATION_FEE = parseUnits("1", 6); // $1.00 USDT
...
function RegisterForm() {
  ...
  const handleRegister = () => {
    ...
    if (usdtBalance !== undefined && usdtBalance < REGISTRATION_FEE) {
      setError(`You need at least $1.00 USDT to register. Balance: $${formatUnits(usdtBalance, 6)}`);
      return;
    }
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 max-w-md w-full text-center">
          ...
          <div className="bg-blue-900/20 border border-blue-800/30 rounded-lg p-3 text-sm text-blue-300 mb-4 text-left">
    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 max-w-md w-full">
        <div className="text-center mb-6">
          <div className="text-5xl mb-4">🚀</div>
          <h2 className="text-2xl font-bold text-white">Join Oslo Protocol</h2>
          <p className="text-gray-400 mt-2">Register to start earning yield on your USDT</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-sm text-gray-400 font-mono break-all">
              {address}
            </div>
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">
              Referral Address <span className="text-gray-500">(optional)</span>
            </label>
            <input
              type="text"
              value={referrer}
              ...
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none font-mono text-sm"
            />
          ...
          {(!registerHash || activeError) && (
            <button
              ...
              disabled={isBusy}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors mt-4"
            >
              {getButtonText()}
            </button>
          )}
        ...
        <div className="mt-6 bg-gray-800/50 rounded-lg p-4 text-xs text-gray-400 space-y-1">
          <p className="font-medium text-gray-300 mb-2">What you get:</p>
