...
// Supports both Mainnet and Testnet based on NEXT_PUBLIC_NETWORK env var

import { CONTRACTS_TESTNET } from './contracts-testnet';
...
export const CONTRACTS = network === 'testnet' ? CONTRACTS_TESTNET : CONTRACTS_MAINNET;
